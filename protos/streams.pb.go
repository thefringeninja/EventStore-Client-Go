...
func (m *ReadReq_Options_UUIDOption) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReadReq_Options_UUIDOption.Unmarshal(m, b)
}
...
func (m *ReadReq_Options_UUIDOption) XXX_Size() int {
	return xxx_messageInfo_ReadReq_Options_UUIDOption.Size(m)
}
...
type ReadReq_Options_UUIDOption_Structured struct {
	Structured *ReadReq_Empty `protobuf:"bytes,1,opt,name=structured,proto3,oneof"`
}

type ReadReq_Options_UUIDOption_String_ struct {
	String_ *ReadReq_Empty `protobuf:"bytes,2,opt,name=string,proto3,oneof"`
}
...
func init() {
	...
	proto.RegisterType((*ReadReq_Options_UUIDOption)(nil), "event_store.grpc.streams.ReadReq.Options.UUIDOption")
...
var fileDescriptor_c6bbf8af0ec331d6 = []byte{
	...
	,
}
